...
export const experiences = [
  {
    title: {
      en: "Founder & DevRel Lead",
      fr: "Fondateur & Responsable DevRel",
      ewe: "Gɔmeɖola kple DevRel Kplɔla",
    },
    organization: "Africa Blockchain Community",
    period: "2024 — Present",
    description: {
      en: "Scaled a Web3 developer community to 2,500+ members, organized 100+ hackathons, workshops, and conferences, built partnerships with Team1, Trust Wallet, Stellar, ICP Hub Sahara, and Web3Bridge, and mentored 300+ developers.",
      fr: "Développement d'une communauté de développeurs Web3 de plus de 2 500 membres, organisation de plus de 100 hackathons, ateliers et conférences, création de partenariats et mentorat de plus de 300 développeurs.",
      ewe: "Web3 dɔwɔla ƒe habɔbɔ dziɖuɖu va se ɖe ame 2,500 ŋu, hackathon kple dɔwɔƒe 100 wu, kple dɔwɔla 300 wu ƒe mɔfiame.",
    },
    tags: ["DevRel", "Community Building", "Partnerships", "Mentorship"],
    priority: 1,
  },
  {
    title: {
      en: "Francophone Director",
      fr: "Directeur Francophone",
      ewe: "Francophone Kplɔla",
    },
    organization: "Ibom Blockchain Experience",
    period: "2026 — Present",
    description: {
      en: "Lead Francophone ecosystem strategy across Africa, develop partnerships, run regional DevRel initiatives, coordinate educational programs, and organize regional events.",
      fr: "Direction de la stratégie de l'écosystème francophone en Afrique, développement de partenariats, pilotage des initiatives DevRel et coordination des programmes éducatifs et événements régionaux.",
      ewe: "Francophone ecosystem ƒe mɔnu ɖoɖo le Afrika, kpekpeɖeŋu, DevRel dɔwɔwɔwo, nusrɔ̃ɖoɖo kple nutome ƒe nudzɔdzɔwo kplɔ.",
    },
    tags: ["DevRel", "Ecosystem Strategy", "Education", "Events"],
    priority: 2,
  },
  {
    title: {
    ...
    description: {
      en: "Support ecosystem growth initiatives, promote Avalanche adoption, and contribute to developer onboarding programs.",
      fr: "Soutien aux initiatives de croissance de l'écosystème, promotion de l'adoption d'Avalanche et contribution aux programmes d'intégration des développeurs.",
      ewe: "Ecosystem ƒe dziɖuɖu dɔwɔwɔwo kpe ɖe ŋu, Avalanche adoption dziɖuɖu kple dɔwɔla yɔyɔ dɔwɔwɔ.",
    },
    tags: ["Avalanche", "Ecosystem Growth", "Developer Onboarding"],
    priority: 3,
  },
  {
    title: {
    ...
    organization: "BNB Chain — Binance Ecosystem",
    period: "2025 — 2026",
    description: {
      en: "Executed developer engagement campaigns and led ecosystem adoption and education initiatives.",
      fr: "Mise en œuvre de campagnes d'engagement des développeurs et pilotage des initiatives d'adoption et d'éducation de l'écosystème.",
      ewe: "Dɔwɔla ƒe kpeɖeŋu campaignwo wɔ kple ecosystem adoption kple nusrɔ̃ɖoɖo dɔwɔwɔwo kplɔ.",
    },
    tags: ["BNB Chain", "Developer Engagement", "Education"],
    priority: 4,
  },
  {
    title: {
      en: "Lead DevRel Ambassador",
      fr: "Ambassadeur DevRel Principal",
      ewe: "DevRel Ambassador Gã",
    },
    organization: "Web3.js",
    period: "2024 — 2025",
    description: {
      en: "Delivered technical workshops and onboarding content, and led ambassador initiatives to promote Web3.js adoption.",
      fr: "Animation d'ateliers techniques et création de contenu d'intégration, avec pilotage des initiatives ambassadeurs pour promouvoir l'adoption de Web3.js.",
      ewe: "Technical dɔwɔƒewo kple onboarding content wɔ, kple ambassador dɔwɔwɔwo kplɔ na Web3.js adoption.",
    },
    tags: ["Web3.js", "DevRel", "Technical Workshops"],
    priority: 5,
  },
  {
    title: {
    ...
    organization: "Stellar — Stellar West Africa",
    period: "2024 — 2025",
    description: {
      en: "Delivered developer workshops and onboarding content for the Stellar ecosystem across West Africa.",
      fr: "Animation d'ateliers développeurs et création de contenu d'intégration pour l'écosystème Stellar en Afrique de l'Ouest.",
      ewe: "Dɔwɔla ƒe dɔwɔƒewo kple onboarding content wɔ na Stellar ecosystem le West Africa.",
    },
    tags: ["Stellar", "West Africa", "Developer Education"],
    priority: 6,
  },
  {
    title: {
      en: "Ecosystem Growth Manager",
      fr: "Responsable de la Croissance de l'Écosystème",
      ewe: "Ecosystem Dziɖuɖu Kplɔla",
    },
    organization: "CodeNekt",
    period: "2022 — 2024",
    description: {
      en: "Built partnerships and community growth strategies, and led ecosystem campaigns and Web3 adoption initiatives.",
      fr: "Création de partenariats et de stratégies de croissance communautaire, ainsi que pilotage de campagnes d'écosystème et d'initiatives d'adoption Web3.",
      ewe: "Kpekpeɖeŋu kple habɔbɔ ƒe dziɖuɖu mɔnu wɔ, kple ecosystem campaignwo kplɔ.",
    },
    tags: ["Ecosystem Growth", "Partnerships", "Web3 Adoption"],
    priority: 7,
  },
  {
    title: {
      ...
      ewe: "Full Stack Dɔwɔla",
    },
    organization: "Dollar Store (Togo)",
    period: "2021 — 2025",
    description: {
      en: "Built internal web applications across the frontend, backend, APIs, and related business systems and automation tools.",
      fr: "Développement d'applications web internes couvrant le frontend, le backend, les API, les systèmes métiers et les outils d'automatisation.",
      ewe: "Internal web applications wɔ le frontend, backend, API kple business systems kpakple automation tools.",
    },
    tags: ["Full Stack", "Web Applications", "APIs", "Automation"],
    priority: 8,
  },
  {
    title: {
      en: "Software Consultant",
      fr: "Consultant Logiciel",
      ewe: "Software Consultant",
    },
    organization: "Afrik informatique — Ministry of Justice",
    period: "2024 — 2025",
    description: {
      en: "Supported digital transformation initiatives for the Ministry of Justice.",
      fr: "Accompagnement des initiatives de transformation numérique du Ministère de la Justice.",
      ewe: "Digital transformation dɔwɔwɔwo kpe ɖe ŋu na Justice Ministry.",
    },
    tags: ["Software Consulting", "Digital Transformation", "Public Sector"],
    priority: 9,
  },
]
