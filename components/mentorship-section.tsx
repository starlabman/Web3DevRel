      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Join hundreds of developers and entrepreneurs I've helped transition into Web3. Whether you're technical or
            non-technical, I'll guide your Web3 journey.
          </p>
        </motion.div>
        ...
        >
          <p className="text-gray-400 mb-4">
            Not sure which program fits you? Let's have a free 15-minute discovery call.
          </p>
          <motion.a
