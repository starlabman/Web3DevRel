...
import { quickLinks, allProjects, allThreads, allPosts, importantArticles, galleryImages } from "@/lib/data"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <BentoCard title={safeT("sections.projects")} size="lg" icon={<Code2 className="w-6 h-6" />}>
                <div className="space-y-3">
                  {projectsLoadMore.visibleItems.map((project, index) => (
                    ...
                    >
                      ...
                      <p className="text-xs text-muted-foreground mb-2 line-clamp-2">{project.blurb}</p>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <BentoCard title={safeT("sections.threads")} size="md" icon={<TrendingUp className="w-5 h-5" />}>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <BentoCard title={safeT("sections.posts")} size="md" icon={<Users className="w-5 h-5" />}>
                <div className="space-y-2">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <BentoCard title={safeT("sections.articles")} size="lg" icon={<BookOpen className="w-5 h-5" />}>
                <div className="space-y-3">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <BentoCard title={safeT("sections.memo")} size="sm" icon={<Zap className="w-5 h-5" />}>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <BentoCard title={safeT("sections.keyAchievements")} size="sm" icon={<TrendingUp className="w-5 h-5" />}>
                <div className="space-y-2 text-sm text-muted-foreground">
                  <p>• Founder ABC Community</p>
                  <p>• Coverner ETHAfrique</p>
                  <p>• DevRel Expert</p>
                  <p>• Ecosystem Builder</p>
                </div>
              </BentoCard>
            </motion.div>
          </motion.div>
